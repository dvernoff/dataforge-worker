...
export function LoadingPage() {
  ...
  useEffect(() => {
    // If already loaded this session, skip straight to home
    if (sessionStorage.getItem('df-loaded')) {
    ...
    // Navigate away after all steps complete
    const totalTime = (STEP_KEYS.length + 1) * STAGGER_DELAY * 1000 + 600;
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background">
      ...
      <div className="relative flex flex-col items-center gap-10">
        ...
        >
          ...
          <span className="text-3xl font-bold">DataForge</span>
        </motion.div>

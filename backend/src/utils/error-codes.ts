...
export const ERROR_CODES: ErrorCodeDef[] = [
  ...
  },
  {
    ...
    pattern: /Expected \d+ bindings, saw 0/i,
    cause: 'Query contains a parameter placeholder but no values were provided.',
    suggestion: 'Ensure every {{name}} in the query has a matching entry in "params". For optional values use COALESCE({{param}}, default_value).',
  },
  {

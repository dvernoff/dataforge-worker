...
export interface TableDefinition {
  ...
  /** Create a btree index on created_at at table creation time. Useful for ORDER BY created_at DESC + range queries. */
  index_created_at?: boolean;
  /** Create a btree index on updated_at. Rarer than created_at — most tables don't sort by updated_at. */
  index_updated_at?: boolean;
